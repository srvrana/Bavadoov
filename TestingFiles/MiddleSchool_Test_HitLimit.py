...
def test():
    """
    Test Script:
    This should attempt to generate a large amount of results.
    This should be limited to 20,000 + the number of math solutions yet to be processed at the time of reaching said limit.
    We set that check at 20,500
    """
    Cooper =  Teacher()
    Cooper.name = "Cooper"
    Cooper.homeRoom = "6"
    ...
    if len(listOfSolutions) < 20500:
        print "Limit on solutions returned working"

    else:
        print "System returned too many results"
